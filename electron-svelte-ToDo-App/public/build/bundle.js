    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "todo-item svelte-1syvzwq");
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button4, "class", "svelte-1syvzwq");
    			add_location(button4, file$1, 129, 16, 4104);
    			add_location(div6, file$1, 128, 12, 4082);
    			attr_dev(div7, "class", "inner-container svelte-1syvzwq");
    			add_location(div7, file$1, 122, 8, 3611);
    			attr_dev(div8, "class", "container svelte-1syvzwq");
    			add_location(div8, file$1, 98, 4, 2584);
    			attr_dev(main, "class", "svelte-1syvzwq");
