    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "todo-item svelte-1l792c0");
    			add_location(div, file$1, 114, 12, 3179);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1l792c0");
    			add_location(h1, file$1, 99, 8, 2616);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "class", "todo-input svelte-1l792c0");
    			attr_dev(input0, "placeholder", "click a to-do, select target date, and hit enter...");
    			add_location(input0, file$1, 100, 8, 2640);
    			attr_dev(div0, "class", "date svelte-1l792c0");
    			add_location(div0, file$1, 103, 12, 2834);
    			attr_dev(button0, "class", "enterButton svelte-1l792c0");
    			add_location(button0, file$1, 110, 8, 3045);
    			attr_dev(div1, "class", "wrapper");
    			add_location(div1, file$1, 102, 8, 2800);
    			attr_dev(input1, "class", "inner-container-input svelte-1l792c0");
    			attr_dev(input1, "type", "checkbox");
    			add_location(input1, file$1, 119, 24, 3414);
    			add_location(label, file$1, 119, 17, 3407);
    			add_location(div2, file$1, 119, 12, 3402);
    			attr_dev(div3, "class", "leftItems svelte-1l792c0");
    			add_location(div3, file$1, 120, 12, 3529);
    			attr_dev(div4, "class", "inner-container svelte-1l792c0");
    			add_location(div4, file$1, 118, 8, 3360);
    			add_location(strong, file$1, 124, 102, 3759);
    			attr_dev(button1, "class", "svelte-1l792c0");
    			toggle_class(button1, "active", /*currentFilter*/ ctx[1] === "all");
    			add_location(button1, file$1, 124, 16, 3673);
    			attr_dev(button2, "class", "svelte-1l792c0");
    			toggle_class(button2, "active", /*currentFilter*/ ctx[1] === "active");
    			add_location(button2, file$1, 125, 16, 3805);
    			attr_dev(button3, "class", "svelte-1l792c0");
    			toggle_class(button3, "completed", /*currentFilter*/ ctx[1] === "completed");
    			add_location(button3, file$1, 126, 16, 3929);
    			add_location(div5, file$1, 123, 12, 3651);
    			attr_dev(button4, "class", "svelte-1l792c0");
    			add_location(button4, file$1, 129, 16, 4102);
    			add_location(div6, file$1, 128, 12, 4080);
    			attr_dev(div7, "class", "inner-container svelte-1l792c0");
    			add_location(div7, file$1, 122, 8, 3609);
    			attr_dev(div8, "class", "container svelte-1l792c0");
    			add_location(div8, file$1, 98, 4, 2584);
    			attr_dev(main, "class", "svelte-1l792c0");
