    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (img.src !== (img_src_value = "https://media.giphy.com/media/ZmdErsWqppgMo/giphy.gif")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "class", "svelte-15ykcvx");
    			add_location(img, file, 34, 1, 748);
    		},
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (img.src !== (img_src_value = /*gif*/ ctx[5])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "class", "svelte-15ykcvx");
    			add_location(img, file, 39, 2, 882);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*gifs*/ 4 && img.src !== (img_src_value = /*gif*/ ctx[5])) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label, file, 28, 1, 597);
    			attr_dev(input, "id", "search");
    			attr_dev(input, "name", "search");
    			add_location(input, file, 29, 1, 633);
    			attr_dev(button, "type", "submit");
    			add_location(button, file, 30, 1, 690);
    			add_location(form, file, 27, 0, 563);
    			attr_dev(div, "class", "results svelte-15ykcvx");
    			add_location(div, file, 37, 0, 837);
    		},
