...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 28, 8, 626);
    			attr_dev(div0, "class", "todo-item-label svelte-falh6z");
    			toggle_class(div0, "completed", /*completed*/ ctx[0]);
    			add_location(div0, file, 29, 8, 710);
    			attr_dev(div1, "class", "todo-item-left svelte-falh6z");
    			add_location(div1, file, 27, 8, 545);
    			attr_dev(div2, "class", "remove-item svelte-falh6z");
    			add_location(div2, file, 32, 4, 797);
    			attr_dev(div3, "class", "todo-item svelte-falh6z");
    			add_location(div3, file, 26, 4, 513);
    			add_location(main, file, 25, 0, 502);
    		},
    ...
    // (90:8) {#each filteredTodos as todo}
    function create_each_block(ctx) {
    	let div;
    	let current;
    	const todoitems_spread_levels = [/*todo*/ ctx[16]];
    	let todoitems_props = {};
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "todo-item svelte-16v7w5n");
    			add_location(div, file$1, 90, 12, 3674);
    		},
    		...
    		p: function update(ctx, dirty) {
    			...
    			? get_spread_update(todoitems_spread_levels, [get_spread_object(/*todo*/ ctx[16])])
    			: {};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(90:8) {#each filteredTodos as todo}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file$1, 84, 9, 3414);
    			attr_dev(div0, "class", "icon svelte-16v7w5n");
    			add_location(div0, file$1, 83, 8, 3386);
    			attr_dev(h1, "class", "svelte-16v7w5n");
    			add_location(h1, file$1, 86, 8, 3473);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "class", "todo-input svelte-16v7w5n");
    			attr_dev(input0, "placeholder", "e.g. Build an app...");
    			add_location(input0, file$1, 87, 8, 3501);
    			attr_dev(input1, "class", "inner-container-input svelte-16v7w5n");
    			attr_dev(input1, "type", "checkbox");
    			add_location(input1, file$1, 95, 24, 3909);
    			add_location(label, file$1, 95, 17, 3902);
    			add_location(div1, file$1, 95, 12, 3897);
    			add_location(div2, file$1, 96, 12, 4024);
    			attr_dev(div3, "class", "inner-container svelte-16v7w5n");
    			add_location(div3, file$1, 94, 8, 3855);
    			add_location(strong, file$1, 100, 102, 4236);
    			attr_dev(button0, "class", "svelte-16v7w5n");
    			toggle_class(button0, "active", /*currentFilter*/ ctx[1] === "all");
    			add_location(button0, file$1, 100, 16, 4150);
    			attr_dev(button1, "class", "svelte-16v7w5n");
    			toggle_class(button1, "active", /*currentFilter*/ ctx[1] === "active");
    			add_location(button1, file$1, 101, 16, 4282);
    			attr_dev(button2, "class", "svelte-16v7w5n");
    			toggle_class(button2, "completed", /*currentFilter*/ ctx[1] === "completed");
    			add_location(button2, file$1, 102, 16, 4406);
    			add_location(div4, file$1, 99, 12, 4128);
    			attr_dev(button3, "class", "svelte-16v7w5n");
    			add_location(button3, file$1, 105, 16, 4579);
    			add_location(div5, file$1, 104, 12, 4557);
    			attr_dev(div6, "class", "inner-container svelte-16v7w5n");
    			add_location(div6, file$1, 98, 8, 4086);
    			attr_dev(div7, "class", "container svelte-16v7w5n");
    			add_location(div7, file$1, 82, 4, 3354);
    			add_location(main, file$1, 81, 0, 3343);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
