...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h2 = element("h2");
    			h2.textContent = "Fetching image";
    			add_location(h2, file, 26, 4, 553);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file, 24, 4, 513);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*gif*/ 2 && img.src !== (img_src_value = /*gif*/ ctx[1])) {
    ...
    function create_fragment(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*gif*/ ctx[1]) return create_if_block;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 18, 1, 383);
    			add_location(button, file, 19, 1, 448);
    			attr_dev(header, "class", "svelte-14db7w8");
    			add_location(header, file, 17, 0, 373);
    			attr_dev(main, "class", "svelte-14db7w8");
    			add_location(main, file, 16, 0, 366);
    		},
    		...
    		m: function mount(target, anchor, remount) {
    			...
    			dispose = [
    				...
    				listen_dev(button, "click", /*getGify*/ ctx[2], false, false, false)
    			];
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ api_key, limit, q, gif, getGify });
    	...
    	return [q, gif, getGify, api_key, input_input_handler];
    }
